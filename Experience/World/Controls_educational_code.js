...
export default class Controls {
  constructor() {
    ...
    // progress value for making something move along a curve
    // this.progress = 0;
  ...
  // Setting a curve to function as a path
  ...
  update() {
    ...
    // Camera movement on a curve while setting it's orientation:
